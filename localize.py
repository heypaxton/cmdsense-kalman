...
class ReadyToLocalize(object):
	...
	# send data to dweet
        dweet = requests.post("https://dweet.io/dweet/for/cmdsense-tag", data={
            "x": position.x,
            "y": position.y,
            "z": position.z
        })
...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x6001, 1, Coordinates(0, 0, 729)),
               DeviceCoordinates(0x606B, 1, Coordinates(660, 0, 798)),
               DeviceCoordinates(0x604E, 1, Coordinates(0, 934, 701)),
               DeviceCoordinates(0x6049, 1, Coordinates(765, 706, 768 ))]
